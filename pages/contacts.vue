  ...
  <div>
    ...
    <div class="contacts bordered">
      <div class="contacts__addresses">
        <div class="address">
          ...
          <p>
            220073 РБ, г.Минск, ул. Бирюзова, д.4,
            корп.9, пом.7, каб.19.
          </p>
          <p class="address__title">Адрес склада:</p>
          <p>
            Минская обл., Минский р-н, Щомыслицкий
            с/с, 76, район д.Богатырево (территория
            базы ОАО «Озтранс» - Минский р-н, п/о
            Озерцо, Меньковский тракт, 21).
          </p>
          ...
          <p>
            р/с BY34 PJCB 3012 0544 9710 0000 0933
            в ОАО «Приорбанк» код PJCBBY2X
            220108 г.Минск, ул. Казинца 92/1
            УНП 192982935.
          </p>
        </div>
        <div class="download">
          <div class="download__req">
            ...
            <p>Скачать <br> реквизиты</p>
          </div>
          <div class="download__route">
            <img src="../assets/img/route.png" alt="скачать схему проезда">
            <p>Скачать <br> схему проезда</p>
          </div>
        </div>
        <div class="law">
          <p>
            Свидетельство о государственной регистрации
            юридического лица: № 192982935 от 13 октября
            2017 г. выданный Мингорисполкомом.
          </p>
        </div>
      </div>
    ...
    <div class="attention bordered block">
      ...
      <p class="attention__text">
        Выписка документов и отпуск продукции производится по адресу: Минская обл., Минский р-н, Щомыслицкий
        сельсовет, район д. Озерцо, производственно-административное здание № 600/С-94119, офис 2 (территория
        базы ОАО «Озтранс» - Минский р-н, п/о Озерцо, Меньковский тракт, 21).
        Возможна предварительная выписка, по согласованию с Вашим менеджером.
        <br>
        <br>
        Обязательно наличие действующего договора поставки. При себе иметь доверенность на получение товара
        (с указанием должности) или копию приказа о назначении директора (в случае, если товар получает
        директор), документ удостоверяющий личность.
      </p>
    </div>
  </div>
</template>
